...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        fun getInstance(context: Context): AppDatabase? {
            ...
            //decision mengecek database apakah ada sudah atau belum
            if (INSTANCE == null) {
        ...
        //ini seharusnya sebua query untuk menghapus instance/database tetapi dalam program aplikasi ini tidak digunakan
        fun destroyInstance() {
            INSTANCE = null
        }
    }
